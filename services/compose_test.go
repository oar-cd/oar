...
func TestComposeProject_HostWorkingDir(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedResult:      "/home/user/.local/share/oar/projects/abc123/git",
		...
		},
		{
			...
			expectedResult:      "/home/user/.local/share/oar/projects/def456/git",
		...
		},
		{
			...
			expectedResult:      "/home/user/.local/share/oar/projects",
		...
		},
		{
			...
			expectedResult:      "/home/user/.local/share/oar/projects/xyz789/git/subdir",
